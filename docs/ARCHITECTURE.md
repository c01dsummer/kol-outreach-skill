...
| `scripts/check/selfcheck-rule.ts` | 检查 | D6 | 上面那条自检里「**续跑的代价说清楚了没有**」的判定：免费和要花钱两句必须二选一，说的还得是**该说的那一句**（该说哪一句由这一轮实际还剩多少活定，说反了要拦），说了要花钱就得说出还剩什么，而且那个「还剩什么」不能是空的。抽出来是为了它能被测、能被变异 —— 留在入口里，ADR-22 那张空头支票的写法就从这条检查自己身上过去了，没有任何东西会红 |
